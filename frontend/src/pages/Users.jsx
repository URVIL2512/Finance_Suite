...
function Users() {
  ...
  const validateAdd = () => {
    ...
    if (!editingUser && (!formData.password || formData.password.length < 8)) return 'Password must be at least 8 characters';
          ...
          >
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="submit"
                  disabled={resetting || resetNewPassword.length < 8 || resetNewPassword !== resetConfirmPassword}
